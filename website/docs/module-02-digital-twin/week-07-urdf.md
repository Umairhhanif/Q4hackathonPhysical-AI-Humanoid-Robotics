---
title: "Week 7: URDF & SDF"
sidebar_position: 2
---

# Week 7: URDF and SDF Robot Description Formats

## Defining Robot Anatomy: The Blueprint of Robotic Systems
...
- **Inertial Property Errors**: "Inertia must be positive definite". *Solution: Ensure inertia matrix is physically valid.*
- **Joint Limit Violations**: Joints moving beyond specified limits. *Solution: Check joint type and limit specifications.*
- **Collision Geometry Problems**: Unexpected collision behavior. *Solution: Verify collision geometries match visual representations.*
...
- **Multi-Link Kinematic Chain**: Base, torso, arms, and end-effectors
- **Accurate Physical Properties**: Mass, inertia, and collision geometries
- **Sensor Integration**: Cameras, LIDAR, and IMUs properly positioned
- **Xacro Modularization**: Reusable components and configurable parameters
- **SDF Extensions**: Simulation-specific properties and surface interactions
- **ROS 2 Compatibility**: Proper frame definitions for tf tree
...
## Key Takeaways
- **URDF** defines robot kinematics and structure with links, joints, and coordinate frames.
- **SDF** extends URDF with simulation features like surface properties and advanced physics.
- **Xacro** enables modular and parameterized designs for reusable robot components.
- **Accurate physical properties** are essential for realistic simulation behavior.
- **Validation and debugging tools** ensure model correctness before simulation deployment.
