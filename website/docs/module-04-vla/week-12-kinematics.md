---
title: "Week 12: Kinematics & Dynamics"
sidebar_position: 2
---
...
- **Forward Kinematics**: Complete humanoid FK with all chains
- **Inverse Kinematics**: Numerical IK solver for arms and legs
- **Dynamics Simulation**: Rigid body dynamics for the whole robot
- **Whole-Body Control**: Hierarchical task control system
- **Motion Planning**: Trajectory generation with dynamics constraints

This project will give you mastery over the mathematical foundations of humanoid motion control.

## Key Takeaways
- **Forward kinematics** transforms joint angles to end-effector poses using DH parameters and homogeneous transformations
- **Inverse kinematics** solves for joint angles given desired poses using analytical or numerical methods
- **Rigid body dynamics** models forces, torques, and motion using Newton-Euler equations
- **Multi-body systems** require careful handling of constraints between connected bodies
- **Whole-body control** manages multiple tasks hierarchically using null space projections
